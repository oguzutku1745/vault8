...
// Import errors directly from the generated TS file to avoid referencing the
// barrel `../errors` which can resolve to a compiled CommonJS wrapper at runtime.
import { getMyOappErrorFromCode, getMyOappErrorFromName } from '../errors/myOapp.ts'
