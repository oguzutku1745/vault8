...
function getLzReceiveTypesAccountsAccountDataSerializer() {
    ...
    ], { description: 'LzReceiveTypesAccountsAccountData' }), function (value) { return (__assign(__assign({}, value), { discriminator: new Uint8Array([248, 87, 167, 117, 5, 251, 21, 126]) })); });
}
...
function fetchLzReceiveTypesAccounts(context, publicKey, options) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, deserializeLzReceiveTypesAccounts(maybeAccount)];
            }
        });
    });
}
function safeFetchLzReceiveTypesAccounts(context, publicKey, options) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    maybeAccount = _a.sent();
                    return [2 /*return*/, maybeAccount.exists ? deserializeLzReceiveTypesAccounts(maybeAccount) : null];
            }
        });
    });
}
function fetchAllLzReceiveTypesAccounts(context, publicKeys, options) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccounts;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function safeFetchAllLzReceiveTypesAccounts(context, publicKeys, options) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccounts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, maybeAccounts
                            ...
                            .map(function (maybeAccount) { return deserializeLzReceiveTypesAccounts(maybeAccount); })];
            }
        });
    });
}
function getLzReceiveTypesAccountsGpaBuilder(context) {
    ...
    return (0, umi_1.gpaBuilder)(context, programId)
        ...
        .deserializeUsing(function (account) { return deserializeLzReceiveTypesAccounts(account); })
