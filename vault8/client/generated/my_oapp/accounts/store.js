...
function getStoreAccountDataSerializer() {
    ...
    ], { description: 'StoreAccountData' }), function (value) { return (__assign(__assign({}, value), { discriminator: new Uint8Array([130, 48, 247, 244, 182, 191, 30, 26]) })); });
}
function deserializeStore(rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount, getStoreAccountDataSerializer());
}
function fetchStore(context, publicKey, options) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, deserializeStore(maybeAccount)];
            }
        });
    });
}
function safeFetchStore(context, publicKey, options) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    maybeAccount = _a.sent();
                    return [2 /*return*/, maybeAccount.exists ? deserializeStore(maybeAccount) : null];
            }
        });
    });
}
function fetchAllStore(context, publicKeys, options) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccounts;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function safeFetchAllStore(context, publicKeys, options) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccounts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, maybeAccounts
                            ...
                            .map(function (maybeAccount) { return deserializeStore(maybeAccount); })];
            }
        });
    });
}
function getStoreGpaBuilder(context) {
    ...
    return (0, umi_1.gpaBuilder)(context, programId)
        ...
        .deserializeUsing(function (account) { return deserializeStore(account); })
