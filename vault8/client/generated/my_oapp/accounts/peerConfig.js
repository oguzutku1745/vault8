...
function getPeerConfigAccountDataSerializer() {
    ...
    ], { description: 'PeerConfigAccountData' }), function (value) { return (__assign(__assign({}, value), { discriminator: new Uint8Array([181, 157, 86, 198, 33, 193, 94, 203]) })); });
}
function deserializePeerConfig(rawAccount) {
    return (0, umi_1.deserializeAccount)(rawAccount, getPeerConfigAccountDataSerializer());
}
function fetchPeerConfig(context, publicKey, options) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, deserializePeerConfig(maybeAccount)];
            }
        });
    });
}
function safeFetchPeerConfig(context, publicKey, options) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    maybeAccount = _a.sent();
                    return [2 /*return*/, maybeAccount.exists ? deserializePeerConfig(maybeAccount) : null];
            }
        });
    });
}
function fetchAllPeerConfig(context, publicKeys, options) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccounts;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function safeFetchAllPeerConfig(context, publicKeys, options) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccounts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, maybeAccounts
                            ...
                            .map(function (maybeAccount) { return deserializePeerConfig(maybeAccount); })];
            }
        });
    });
}
function getPeerConfigGpaBuilder(context) {
    ...
    return (0, umi_1.gpaBuilder)(context, programId)
        ...
        .deserializeUsing(function (account) { return deserializePeerConfig(account); })
