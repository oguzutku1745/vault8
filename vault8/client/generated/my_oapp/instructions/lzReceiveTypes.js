...
function getLzReceiveTypesInstructionDataSerializer() {
    ...
    ], { description: 'LzReceiveTypesInstructionData' }), function (value) { return (__assign(__assign({}, value), { discriminator: new Uint8Array([221, 17, 246, 159, 248, 128, 31, 96]) })); });
}
// Instruction.
function lzReceiveTypes(context, input) {
    ...
    // Keys and Signers.
    var _b = (0, shared_1.getAccountMetasAndSigners)(orderedAccounts, 'programId', programId), keys = _b[0], signers = _b[1];
    // Data.
    var data = getLzReceiveTypesInstructionDataSerializer().serialize(resolvedArgs);
